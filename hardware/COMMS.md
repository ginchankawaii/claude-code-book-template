...
- **v1 は生PCM のまま送る**（IMA-ADPCM の4:1圧縮 = 29MB/時 は v2 候補。`firmware/SPEC.md` §3.2）
- 15時間装着 → VADゲート(デューティ35%)込みで **約600 MB/日**。無音を捨てない worst case では 1.7GB

600MB を BLE で運ぶと、ESP32 の実効スループット（2M PHY でも実測 100〜200KB/s 程度）では
