...
def build():
    ...
    table_slide(
        ...
        [2.6, 9.2],
        footer="各演習は「打つコマンド → 出てくる出力 → いま何が起きたか」の 3 点セットです。3 つめが本体です",
        fsize=14,
    )
    ...
    bullet_slide(
        ...
        [
            ...
            (1, "「いまラボは RA 方式です。ひかり電話なしのお客様と同じ状態です」と宣言", ""),
            (0, "【あなた】892FJ で", "b"),
    ...
    bullet_slide(
        ...
        [
            ...
            (1, "「いま PD 方式にしました。ひかり電話ありのお客様と同じ状態です」と宣言", ""),
    ...
    table_slide(
        prs,
        "演習 2 で何が起きたか — ここを 5 分かけて説明してください",
        ["", "RA 方式", "PD 方式"],
        [
