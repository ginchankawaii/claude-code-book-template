...
def build():
    ...
    bullet_slide(
        ...
        [
            ...
            (1, "サイクル 1〜6 実走済み。R1〜R6/D1 の 7 件も実測完了", ""),
    ...
    bullet_slide(
        ...
        [
            ...
            (1, "この違いが「MAP-E が組めるか」に直結します(第4部の実測を参照)", "w"),
        ],
    ...
    table_slide(
        ...
        [
            ...
            ["ユニークローカル(ULA)", "fd00::/8", "組織内だけ", "自分で決める", "OpenWrt が既定で作る。事故の元(第3部で扱う)"],
    ...
    bullet_slide(
        ...
        footer="教科書: 第5章「近隣探索プロトコル(NDP)」/ 第6章",
    )
    ...
    branch_slide(
        ...
        note=[
            ...
            "M=0 → SLAAC だけ。M=1 → DHCPv6 でアドレスをもらう。O=1 → DNS 等だけ DHCPv6 から。",
    ...
    bullet_slide(
        ...
        [
            ...
            (1, "③ CML (Cat8000v。892FJ が MAP-E 非対応なので、MAP-E の実機確認はこちら)", ""),
            (0, "覚えておいてほしい結論", "w"),
    ...
    table_slide(
        ...
        [
            ...
            ["ping 203.0.113.80", "0% 損失 / TTL=62", "2 ホップ減っている = トンネルを経由している"],
    ...
    bullet_slide(
        prs,
        "実機 CE で 240 ポートを数えたかった — Cisco IOS XE で試した結果",
        [
            (0, "なぜやったか", "b"),
