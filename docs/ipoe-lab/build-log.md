...
| 5 | トラブル再現レシピ R1/R3/R4/R5 を実走して再現条件を確定 | **R3/R4/R5 完了**(R1 は次回) | 約 60 分 | **3 件とも「レシピのままでは想定と違った」**。R3 は 240 でなく 16 で詰まる / R4 は待受の対照実験が無いと誤判定する / R5 は MSS clamp と PMTU キャッシュの 2 つを外さないと再現しない |
...
**R3・R4・R5 を実走。3 件とも「レシピのままでは想定と違う」ことが判明した。**
R1 は未実施(次回)。
...
**残り**: R1(RA 方式に PD 設定)は次回。R2 / R6 / D1 も未実施。
